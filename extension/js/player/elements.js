...
class Elements{
    constructor(){
        ...
        this.interface = document.querySelector(".player-interface");
        this.interfaceTop = this.interface.querySelector(".player-interface__top");
        this.interfaceBottom = this.interface.querySelector(".player-interface__bottom");
        ...
        this.userSettingsButton = this.interface.querySelector(".user-settings-button");
        this.userSettingsContainer = document.querySelector(".user-settings-container");
    }
}
